...
typedef enum RISCVException {
    ...
    RISCV_EXCP_INSTRUCTION_COUNT_OVERFLOW_ERROR = 0x18,
    RISCV_EXCP_INSTRUCTION_COUNT_SET_ERROR = 0x19,
    RISCV_EXCP_ILLEGAL_RET_ERROR = 0x1a,
    RISCV_EXCP_SET_RET_ERROR = 0x1b,
    RISCV_EXCP_ILLEGAL_JMP_ERROR = 0x1c,
    RISCV_EXCP_SET_JMP_ERROR = 0x1d,
} RISCVException;
